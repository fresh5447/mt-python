  ...
  render() {
    ...
    <div>
      <Jumbotron className="admin-jumbo">
        ...
        <NavLink className="btn btn-warning" to={ "/admin-console/bsca/courses/edit/" + this.props.params.course_id}>Edit</NavLink>
        <NavLink className="btn btn-success" to={ "/admin-console/bsca/course/" + this.props.params.course_id + "/modules"}>Go</NavLink>
